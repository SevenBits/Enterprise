...
static bool copy_file(const char * const, const char* const) __attribute__((nonnull (1,2)));
static bool copy_file(const char * const source, const char * const destination) {
	char *buffer;
